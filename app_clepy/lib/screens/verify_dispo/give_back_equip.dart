...
import 'package:app_clepy/screens/confirm_rent/confirm_screen.dart';

class GiveBack extends StatefulWidget {
  const GiveBack({ Key? key }) : super(key: key);

  @override
  _GiveBackState createState() => _GiveBackState();
}

class _GiveBackState extends State<GiveBack> {
  int _selectedDay = 2;
            ...
            return <Widget>[
              SliverToBoxAdapter(
                  child: FadeAnimation(1, Padding(
                    ...
                    child: Text(
                      'Selecione a data e o \nhorário para devolver \no equipamento',
                      style: TextStyle(
                        fontSize: 35,
